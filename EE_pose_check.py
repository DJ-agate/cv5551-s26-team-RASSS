...
def main():
    ...
    try:
        ...
        grasp_RT = RigidTransform.from_matrix(grasp_pose)

        roll, pitch, yaw = grasp_RT.rotation.as_euler('xyz', degrees=True)
        x,y,z = grasp_RT.translation
        traj = [arm.get_position()[1],[x,y,z,roll,pitch,yaw]]

        arm.move_arc_lines(traj)
        
        # arm.set_position(x,y,z,roll,pitch,yaw,is_radian=None,wait=True, speed=50)
